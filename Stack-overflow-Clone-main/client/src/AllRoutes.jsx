...
import JobPortalEmbed from "./actions/JobPortalEmbed";
import StreamlitEmbed from "./actions/Airesume";
...
const AllRoutes = ({ slideIn, handleSlideIn }) => {
  return (
    <Routes>
      ...
      />
      <Route path="/JobPortalEmbed" element={<JobPortalEmbed />} />
      <Route path="/Airesume" element={<StreamlitEmbed />} />
    </Routes>
  );
};
